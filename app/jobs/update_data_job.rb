  ...
  def perform(*args)
    Contest.all.each do |contest|
      ...
      unless Photo.find_by(pageid: photo['pageid'])
          ...
          globalusage = HTTParty.get("https://commons.wikimedia.org/w/api.php?action=query&prop=globalusage&pageids=#{photo['pageid']}.jpg&gunamespace=0&format=json", uri_adapter: Addressable::URI).to_a[1][1]['pages']['-1']['globalusage'].empty?
