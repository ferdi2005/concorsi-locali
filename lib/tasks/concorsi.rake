...
namespace :db do
  ...
  task :concorsi => :environment do
    ...
    #  Contest.create(region: "Lake Como", category: "Category:Images from Wiki Loves Monuments #{Date.today.year} in Italy - Lake Como", name: "WLM Lake Como", url: "https://www.wikimedia.it/wiki-loves-monuments/concorsi-locali/lago-di-como", year: Date.today.year)
    ...
    # Abruzzo
    Contest.create(region: "Abruzzo", category: "Category:Images from Wiki Loves Monuments #{Date.today.year} in Italy - Abruzzo", name: "Abruzzo", url: "https://www.wikimedia.it/wiki-loves-monuments/concorsi-locali/abruzzo/", year: Date.today.year)
    puts "Creating Abruzzo..."
    # Basilicata
    Contest.create(region: "Basilicata", category: "Category:Images from Wiki Loves Monuments #{Date.today.year} in Italy - Basilicata", name: "Basilicata", url: "https://www.wikimedia.it/wiki-loves-monuments/concorsi-locali/", year: Date.today.year)
    puts "Creating Basilicata..."
    # Veneto
    Contest.create(region: "Veneto", category: "Category:Images from Wiki Loves Monuments #{Date.today.year} in Italy - Veneto", name: "Veneto",url: "https://www.wikimedia.it/wiki-loves-monuments/concorsi-locali/", year: Date.today.year)
    puts "Creating Veneto..."
    # Liguria
    Contest.create(region: "Liguria", category: "Category:Images from Wiki Loves Monuments #{Date.today.year} in Italy - Liguria", name: "Wiki Loves Liguria", url: "https://www.wikimedia.it/wiki-loves-monuments-concorsi-locali-liguria/", year: Date.today.year)
    puts "Creating Liguria..."
    # Umbria
    Contest.create(region: "Umbria", category: "Category:Images from Wiki Loves Monuments #{Date.today.year} in Italy - Umbria", name: "Wiki Loves Umbria", url: "https://www.wikimedia.it/wiki-loves-monuments/concorsi-locali/", year: Date.today.year)
    puts "Creating Umbria..."
    # Lombardia
    Contest.create(region: "Lombardia", category: "Category:Images from Wiki Loves Monuments #{Date.today.year} in Italy - Lombardy", name: "Wiki Loves Lombardia", url: "https://www.wikimedia.it/wiki-loves-monuments/concorsi-locali", year: Date.today.year)
    ...
    Contest.create(region: "Friuli-Venezia Giulia", category: "Category:Images from Wiki Loves Monuments #{Date.today.year} in Italy - Friuli-Venezia Giulia", name: "Wiki Loves Friuli Venezia Giulia", url: "https://www.wikimedia.it/wiki-loves-monuments/concorsi-locali/", year: Date.today.year)
    puts "Creating Friuli-Venezia Giulia..."
    # Marche
    Contest.create(region: "Marche", category: "Category:Images from Wiki Loves Monuments #{Date.today.year} in Italy - Marche", name: "Wiki Loves Marche", url: "https://commons.wikimedia.org/wiki/Commons:Wiki_Loves_Monuments_in_Italy/Marche", year: Date.today.year)
    ...
    # Piemonte
    Contest.create(region: "Piemonte", category: "Category:Images from Wiki Loves Monuments #{Date.today.year} in Italy - Piedmont", name: "Wiki Loves Piemonte", url: "https://commons.wikimedia.org/wiki/Commons:Wiki_Loves_Monuments_in_Italy/Piedmont_and_Aosta_Valley", year: Date.today.year)
